...
public class DataHealthPanel extends DataPanel {
	...
	public DataHealthPanel(Home home, Originator ori, CareTaker care)
	{
		this.home = home;
		super.ori = ori;
		super.care = care;
		...
		setLayout(null);
	 	JLabel title = new JLabel("Hearth Insurance",SwingConstants.CENTER);
    	...
    	add(l14);
    	l14.setBounds(10, 430, 100, 30);
    	txtaddress=new JTextField();
    	txtaddress.setBounds(130, 430, 150, 30);
    	add(txtaddress);
    	
    	JLabel l15=new MyJLabel("Tel Number :");
    	add(l15);
    	l15.setBounds(10, 480, 100, 30);
    	txttel=new JTextField();
    	txttel.setBounds(130, 480, 150, 30);
    	add(txttel);
    	
    	JLabel l16=new MyJLabel("Limit Of Covering :");
    	l16.setBounds(10, 550, 140, 30);
    	add(l16);
    	
    	limit1=new JRadioButton("50000$");
    	limit1.setBounds(155, 550, 80, 30);
    	grp2.add(limit1);
    	add(limit1);
    	
    	limit2=new JRadioButton("75000$");
    	limit2.setBounds(235, 550, 80, 30);
    	grp2.add(limit2);
    	add(limit2);
    	
    	limit3=new JRadioButton("100000$");
    	limit3.setBounds(315, 550, 80, 30);
    	grp2.add(limit3);
    	add(limit3);
    	
    	limit4=new JRadioButton("200000$");
    	limit4.setBounds(395, 550, 80, 30);
    	grp2.add(limit4);
    	add(limit4);
    	
    	JLabel l18=new MyJLabel("Username :");
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if(!txtusername.getText().equals("")&&!(new String(txtpassword.getPassword()).equals("")))
			{
				...
				if(count==0)
				{
					...
					statement.execute("insert into health(application,date,insuredname,firstname,fathername,mothername,birthdate,birthplace,maritalstate,nbchildren,job,address,tel,limitcovering,username)"
							+ "values('"+txtappnb.getText()+"','"+txtdate.getText()+"','"+txtownername.getText()+"','"+txtownerfname.getText()+"','"+txtfathername.getText()+"','"+txtmothername.getText()+"','"+txtbirthdate.getText()+"','"+txtbirthplace.getText()+"','"+state+"','"+txtnbchildren.getText()+"','"+txtjob.getText()+"','"+txtaddress.getText()+"','"+txttel.getText()+"','"+mylimit+"','"+txtusername.getText()+"')");
			...
			statement.execute("insert into health(application,date,insuredname,firstname,fathername,mothername,birthdate,birthplace,maritalstate,nbchildren,job,address,tel,limitcovering)"
					+ "values('"+txtappnb.getText()+"','"+txtdate.getText()+"','"+txtownername.getText()+"','"+txtownerfname.getText()+"','"+txtfathername.getText()+"','"+txtmothername.getText()+"','"+txtbirthdate.getText()+"','"+txtbirthplace.getText()+"','"+state+"','"+txtnbchildren.getText()+"','"+txtjob.getText()+"','"+txtaddress.getText()+"','"+txttel.getText()+"','"+mylimit+"')");
			ori.setState(new Person(txtownerfname.getText(), txtownername.getText(), txtmothername.getText(), txtfathername.getText(), txtbirthdate.getText(), txtbirthplace.getText(), txtaddress.getText(), txttel.getText()));
			care.add(ori.saveStateTomemento());
			clear();
			}
